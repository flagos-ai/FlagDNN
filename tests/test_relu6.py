...
@pytest.mark.parametrize("shape, inplace", RELU6_CASES)
def test_accuracy_relu6(dtype, shape, inplace):
    ...
    out_ref = F.relu6(x_ref, inplace=inplace)

    with flag_dnn.use_dnn():
        out_custom = F.relu6(x_custom, inplace=inplace)

...
@pytest.mark.parametrize("shape, inplace", MISH_CASES)
def test_accuracy_mish(dtype, shape, inplace):
    ...
    out_ref = F.mish(x_ref, inplace=inplace)

    with flag_dnn.use_dnn():
        out_custom = F.mish(x_custom, inplace=inplace)

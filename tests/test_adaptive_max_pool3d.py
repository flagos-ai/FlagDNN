...
def test_accuracy_adaptive_max_pool3d(
    ...
    ref_out = F.adaptive_max_pool3d(
        x, output_size, return_indices=return_indices
    )

    with flag_dnn.use_dnn():
        out = F.adaptive_max_pool3d(
            x, output_size, return_indices=return_indices
        )
...
def test_accuracy_adaptive_max_pool3d_empty_tensor(dtype, return_indices):
    ...
    with flag_dnn.use_dnn():
        out = F.adaptive_max_pool3d(x, 2, return_indices=return_indices)

...
def register_default_ops() -> None:
    ...
    register_op(
        OpSchema(
            name="sdpa",
            normalize_fn=_normalize_sdpa,
            shape_fn=_sdpa_shape,
            run_fn=_run_sdpa(flag_ops),
            num_outputs=2,
            fusible=True,
        )
    )
    ...
    register_op(
        OpSchema(
            name="sdpa_backward",
            normalize_fn=_normalize_sdpa_backward,
            shape_fn=_sdpa_backward_shape,
            run_fn=_run_sdpa_backward(flag_ops),
            num_outputs=3,
        )
    )

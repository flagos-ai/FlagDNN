# Installing python3-flag-dnn

After `apt install python3-flag-dnn` (Debian/Ubuntu) or `dnf install python3-flag-dnn` (Fedora),
...
FlagDNN needs PyTorch (GPU build) at runtime:

...
| `rmsnorm_rht_amax_wrapper_sm100` | `x_tensor, w_tensor, eps=1e-5, num_threads=None, rows_per_cta=None, current_stream=None` | 部分；有 rms_norm，但缺 RHT 和 amax | `ops/rmsnorm_rht_amax.py` |

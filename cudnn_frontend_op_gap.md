...
| `causal_conv1d` high-level | `x, weight, bias=None, activation='identity'` | 已有 eager + Graph + tests_graph + benchmark_graph；支持 depthwise causal padding、bias、`identity`/`silu` | 已有 |

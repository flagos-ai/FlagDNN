...
#ifndef FLAGDNN_BACKENDS_MTHREADS_ENGINES_ENGINE_HPP_
#define FLAGDNN_BACKENDS_MTHREADS_ENGINES_ENGINE_HPP_
...
create_libtriton_jit_engine(
    const EngineBuildContext& context,
    MthreadsArtifact artifact);

}  // namespace flagdnn::mthreads

#endif  // FLAGDNN_BACKENDS_MTHREADS_ENGINES_ENGINE_HPP_
